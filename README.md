      ...
      Gambar
        ...
        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
          ...
          <div class="carousel-inner">
				...
				<img class="d-block w-100" src="ALIA 1.png" alt="First slide" />
            </div>
                      </div>
          <a class="carousel-control-prev" href="ALIA 2.png" role="button" data-slide="prev">
            <span class="carousel-control-custom-icon" aria-hidden="true">
              <i class="fas fa-chevron-left"></i>
            </span>
            <span class="sr-only">Previous</span>
          </a>
          <a class="carousel-control-next" href="ALIA 3.png" role="button" data-slide="next">
            <span class="carousel-control-custom-icon" aria-hidden="true">
        ...
        <table class="table table-bordered">
          <tbody>
			 <tr>
              <td> Lokasi  </td>
              <td>:</td>
              <td>Jalan Tebet Utara IV E No. 9B Rt 002 Rw 002, Kelurahan Tebet Timur , Kecamatan Tebet, Kotamadya Jakarta Selatan , Provinsi DKI Jakarta .																											
			</td>
            </tr>
			 <tr>
              <td>Basis Nilai</td>
...
<tr>
              <td> Lokasi  </td>
              <td>:</td>
              <td> Jalan Tebet Utara IV G No. 18 </td>
            </tr>
			<tr>
              <td>Titik Koordinat</td>
              <td>:</td>
              <td><a href="https://www.google.com/maps/place/6%C2%B013'39.7%22S+106%C2%B051'11.9%22E/@-6.2276847,106.8507271,17z/data=!3m1!4b1!4m4!3m3!8m2!3d-6.22769!4d106.853302?entry=ttu">
 -6.227690, 106.853302								
                  </a></td>
            </tr>
			<tr>
        ...
        <table class="table table-bordered">
          <tbody>
			<tr>
              <td> Lokasi  </td>
              <td>:</td>
              <td> Jalan Tebet Utara IV G No. 18  	
	</td>
            </tr>
			<tr>
              <td>Titik Koordinat</td>
              <td>:</td>
              <td><a href="https://www.google.com/maps/place/6%C2%B013'42.1%22S+106%C2%B051'15.3%22E/@-6.2276847,106.8507271,17z/data=!4m4!3m3!8m2!3d-6.228373!4d106.854262?entry=ttu">
-6.228373, 106.854262						
                  </a></td>
            </tr>
			<tr>
        ...
        <table class="table table-bordered">
         <tbody>
			<tr>
              <td> Lokasi  </td>
              <td>:</td>
              <td> Jalan Tebet Utara IV E No. 19  		
	</td>
            </tr>
			<tr>
              <td>Titik Koordinat</td>
              <td>:</td>
              <td><a href="https://www.google.com/maps/place/6%C2%B013'42.1%22S+106%C2%B051'16.1%22E/@-6.2283407,106.8518851,17z/data=!3m1!4b1!4m4!3m3!8m2!3d-6.228346!4d106.85446?entry=ttu">
 -6.228346, 106.854460		
                  </a></td>
            </tr>
			<tr>
